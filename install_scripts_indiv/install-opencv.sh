...
# This script was originally created by willprice
# Got from : https://gist.github.com/willprice/c216fcbeba8d14ad1138
...
# Might have some trouble here with zsh (install with bash recommended)
    source /usr/local/bin/virtualenvwrapper.sh
#    mkvirtualenv -p python3 cv
# In personally prefer to have opencv installed globally
#    workon cv
    install_local_python_dependences
}
